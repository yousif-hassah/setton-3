      ...
      <div className="container mx-auto  py-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-3xl font-bold text-orange-600 tracking-tighter"><img src="src/components/image_2025-05-23_19-57-16-Photoroom.png" alt="" style={{width:"120px" ,height:"30px"}}/>
